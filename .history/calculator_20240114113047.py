...
addition_button = Button(root, text='+',padx=40,pady=20, command=button_add).grid(row=4, column=1)
equals_button = Button(root, text='=',padx=91,pady=20, command=button_add).grid(row=4, column=2)
clear_button = Button(root, text='Clear',padx=79,pady=20, command=button_add).grid(row=4, column=2)
