...
subtract_button = Button(root, text='-',padx=40,pady=20, command=subtract).grid(row=6, column=0)
divide_button = Button(root, text='/',padx=40,pady=20, command=divide).grid(row=6, column=1)
multiply_button = Button(root, text='X',padx=40,pady=20, command=multiply).grid(row=6, column=2)
