...
def text_display():
    myLabel = Label(root, text='this is the text display function').grid(row=4,column=3)

another_button = Button(root, text='call the func',bg='green', fg='white', command=text_display).grid(row=3, column=2)
