...
my_image6= ImageTk.PhotoImage(Image.open('img/7.jpg')).resize((150,150),Image.ANTIALIAS)


image_list=[my_image,my_image1,my_image2,my_image3,my_image4,my_image5,my_image6]
