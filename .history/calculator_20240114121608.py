...
subtract_button = Button(root, text='-',padx=40,pady=20, command=subtract).grid(row=5, column=0)
divide_button = Button(root, text='/',padx=40,pady=20, command=divide).grid(row=5, column=0)
multiply_button = Button(root, text='X',padx=40,pady=20, command=multiply).grid(row=5, column=0)
